...
const AUTO_ACCOUNT_RULES = [
  ...
  { pattern: /\birugami\b/i, accountId: "17", projectUid: "IR17" },
  { pattern: /\bstprm\b|\bcomms\s*l[ií]der\b/i, accountId: "18", projectUid: "ST18" },
  { pattern: /\bcasa\s*mata\b|\bpujol\b/i, accountId: "19", projectUid: "CM19" },
  { pattern: /\bveracruz\b|\bhaddad\b/i, accountId: "20", projectUid: "VE20" },
  { pattern: /\bnuvoil\b/i, accountId: "21", projectUid: "NU21" },
  { pattern: /\bandy\b|\bandycoach\b|\binsta\s*coach\b/i, accountId: "25", projectUid: "AN25" },
  { pattern: /\bbernardo\b|\bbv seguimiento\b/i, accountId: "26", projectUid: "BV26" },
  { pattern: /\bcuernavaca\b/i, accountId: "27", projectUid: "CU27" },
  { pattern: /\bquer[eé]taro\b/i, accountId: "28", projectUid: "QU28" },
  { pattern: /\bcoast\s*oil\b/i, accountId: "29", projectUid: "CO29" },
  { pattern: /\berick\s*rubi\b/i, accountId: "30", projectUid: "ER30" },
  { pattern: /\bneza\b|\bnezahualc[oó]yotl\b/i, accountId: "33", projectUid: "NE33" },
